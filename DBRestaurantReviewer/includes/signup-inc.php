...
session_start();
  if (isset($_POST['submit'])) {
    include 'db-inc.php';
		...
		/*$sql = "SELECT Username FROM User WHERE Username = '$username'"; // Get data from table
		...
		if($row = mysqli_fetch_assoc($result)){ // Checks table data
			...
			$message1 = "Password is less than 8 characters";
			...
			$query = "INSERT INTO USER (Username, Password, FirstName, LastName) VALUES ('$username', MD5('$password'), '$firstname', '$lastname')";
